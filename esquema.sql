...
-- Volcando estructura para tabla vol_brand
CREATE TABLE IF NOT EXISTS `vol_brand` (
...
-- Volcando estructura para tabla vol_category
...
-- Volcando estructura para tabla vol_category_sub
CREATE TABLE IF NOT EXISTS `vol_category_sub` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  ...
  `active` bit(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`id`),
  KEY `FK_vol_category_sub_category` (`category_id`),
  CONSTRAINT `FK_vol_category_sub_category` FOREIGN KEY (`category_id`) REFERENCES `vol_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='almacena las subcategorias o clasificadores de la tienda\r\n';

-- La exportación de datos fue deseleccionada.


-- Volcando estructura para tabla vol_cms
CREATE TABLE IF NOT EXISTS `vol_cms` (
...
-- Volcando estructura para tabla vol_comment
CREATE TABLE IF NOT EXISTS `vol_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_vol_comment_post` (`post_id`),
  CONSTRAINT `FK_vol_comment_post` FOREIGN KEY (`post_id`) REFERENCES `vol_post` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- La exportación de datos fue deseleccionada.


-- Volcando estructura para tabla vol_lookup
CREATE TABLE IF NOT EXISTS `vol_lookup` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla vol_newsletter
CREATE TABLE IF NOT EXISTS `vol_newsletter` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla vol_post
CREATE TABLE IF NOT EXISTS `vol_post` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_vol_post_user` (`author_id`),
  CONSTRAINT `FK_vol_post_user` FOREIGN KEY (`author_id`) REFERENCES `vol_user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

-- La exportación de datos fue deseleccionada.


-- Volcando estructura para tabla vol_product
CREATE TABLE IF NOT EXISTS `vol_product` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_vol_product_category` (`category_id`),
  KEY `FK_vol_product_subcategory` (`subcategory_id`),
  KEY `FK_vol_product_brand` (`brand_id`),
  CONSTRAINT `FK_vol_product_brand` FOREIGN KEY (`brand_id`) REFERENCES `vol_brand` (`id`),
  CONSTRAINT `FK_vol_product_category` FOREIGN KEY (`category_id`) REFERENCES `vol_category` (`id`),
  CONSTRAINT `FK_vol_product_subcategory` FOREIGN KEY (`subcategory_id`) REFERENCES `vol_category_sub` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- La exportación de datos fue deseleccionada.


-- Volcando estructura para tabla vol_product_color
CREATE TABLE IF NOT EXISTS `vol_product_color` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_vol_product_color_product` (`product_id_show`),
  KEY `FK_vol_product_color_product_2` (`product_id_from`),
  CONSTRAINT `FK_vol_product_color_product` FOREIGN KEY (`product_id_show`) REFERENCES `vol_product` (`id`),
  CONSTRAINT `FK_vol_product_color_product_2` FOREIGN KEY (`product_id_from`) REFERENCES `vol_product` (`id`)
...
-- Volcando estructura para tabla vol_product_image
CREATE TABLE IF NOT EXISTS `vol_product_image` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  `active` bit(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`id`),
  KEY `FK_vol_product_image_product` (`product_id`),
  CONSTRAINT `FK_vol_product_image_product` FOREIGN KEY (`product_id`) REFERENCES `vol_product` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='contenedor de las imagenes por producto';

-- La exportación de datos fue deseleccionada.


-- Volcando estructura para tabla vol_product_info
CREATE TABLE IF NOT EXISTS `vol_product_info` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla vol_product_specification
CREATE TABLE IF NOT EXISTS `vol_product_specification` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  `active` bit(1) NOT NULL DEFAULT b'1',
  PRIMARY KEY (`id`),
  KEY `FK_vol_product_specification_product` (`product_id`),
  CONSTRAINT `FK_vol_product_specification_product` FOREIGN KEY (`product_id`) REFERENCES `vol_product` (`id`)
...
-- Volcando estructura para tabla vol_slide
CREATE TABLE IF NOT EXISTS `vol_slide` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `image` varchar(50) NOT NULL DEFAULT 'noimage.jpg',
...
-- Volcando estructura para tabla vol_specification
CREATE TABLE IF NOT EXISTS `vol_specification` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT '',
  PRIMARY KEY (`id`)
...
-- Volcando estructura para tabla vol_store
CREATE TABLE IF NOT EXISTS `vol_store` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `name` varchar(80) NOT NULL DEFAULT '',
...
-- Volcando estructura para tabla vol_tag
...
-- Volcando estructura para tabla vol_tag_blog
CREATE TABLE IF NOT EXISTS `vol_tag_blog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `frequency` int(11) DEFAULT '1',
  PRIMARY KEY (`id`)
...
-- Volcando estructura para tabla vol_type
CREATE TABLE IF NOT EXISTS `vol_type` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- Volcando estructura para tabla vol_user
