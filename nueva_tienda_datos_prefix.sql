...
/*!40000 ALTER TABLE `{prefix}brand` DISABLE KEYS */;
INSERT INTO `{prefix}brand` (`id`, `name`, `description`, `image`, `active`) VALUES
  (8, 'generica', 'generica', 'noimage.jpg', b'10000000');
/*!40000 ALTER TABLE `{prefix}brand` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.category: ~6 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}category` DISABLE KEYS */;
INSERT INTO `{prefix}category` (`id`, `name`, `description`, `image`, `active`) VALUES
...
/*!40000 ALTER TABLE `{prefix}cms` DISABLE KEYS */;
INSERT INTO `{prefix}cms` (`id`, `name`, `content`) VALUES
  (1, 'about', '<p>Acerca de nosotros. sdsd</p>\r\n');
/*!40000 ALTER TABLE `{prefix}cms` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.comment: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}comment` DISABLE KEYS */;
INSERT INTO `{prefix}comment` (`id`, `content`, `status`, `create_time`, `author`, `email`, `url`, `post_id`) VALUES
...
/*!40000 ALTER TABLE `{prefix}lookup` DISABLE KEYS */;
INSERT INTO `{prefix}lookup` (`id`, `name`, `code`, `type`, `position`) VALUES
...
/*!40000 ALTER TABLE `{prefix}lookup` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.newsletter: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}newsletter` DISABLE KEYS */;
INSERT INTO `{prefix}newsletter` (`id`, `name`, `email`, `created`) VALUES
  (1, 'asdf', 'mail@mail.com', '2014-09-11 02:01:47'),
  (2, 'asdf', 'calogeroboy@gmail.com', '2014-09-11 18:56:38');
/*!40000 ALTER TABLE `{prefix}newsletter` ENABLE KEYS */;


-- Volcando datos para la tabla publicidad.post: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}post` DISABLE KEYS */;
INSERT INTO `{prefix}post` (`id`, `title`, `content`, `tags`, `status`, `create_time`, `update_time`, `author_id`, `image`) VALUES
...
/*!40000 ALTER TABLE `{prefix}post` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.product: ~9 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}product` DISABLE KEYS */;
INSERT INTO `{prefix}product` (`id`, `code`, `name`, `description`, `price`, `image`, `tags`, `new`, `address`, `phone`, `email`, `web`, `map`, `type`, `brand_id`, `category_id`, `subcategory_id`, `active`, `video`, `color`, `in_stock`) VALUES
...
/*!40000 ALTER TABLE `{prefix}product` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.product_image: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}product_image` DISABLE KEYS */;
INSERT INTO `{prefix}product_image` (`id`, `product_id`, `image`, `title`, `alt`, `position`, `active`) VALUES
  (1, 10, 'volante_en_linea.jpg', '-', '-', 0, b'10000000');
/*!40000 ALTER TABLE `{prefix}product_image` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.product_specification: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}product_specification` DISABLE KEYS */;
INSERT INTO `{prefix}product_specification` (`id`, `product_id`, `name`, `value`, `description`, `active`) VALUES
  (46, 10, '44', '-', '-', b'10000000'),
  (47, 10, 'height', '-', '-', b'10000000'),
  (48, 10, 'large', '-', '-', b'10000000'),
  (49, 10, 'volume', '-', '-', b'10000000'),
  (50, 10, 'weight', '-', '-', b'10000000');
/*!40000 ALTER TABLE `{prefix}product_specification` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.slide: ~7 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}slide` DISABLE KEYS */;
INSERT INTO `{prefix}slide` (`id`, `image`, `alt`, `comment`, `position`, `width`, `height`, `active`) VALUES
  (190, 'highlights_holbi.png', '', '', 0, '', '', 1);
/*!40000 ALTER TABLE `{prefix}slide` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.specification: ~5 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}specification` DISABLE KEYS */;
INSERT INTO `{prefix}specification` (`id`, `name`) VALUES
  (1, 'weight'),
  (2, 'height'),
  (3, 'volume'),
  (4, 'large'),
  (5, '44');
/*!40000 ALTER TABLE `{prefix}specification` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.store: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}store` DISABLE KEYS */;
INSERT INTO `{prefix}store` (`id`, `name`, `address`, `image`, `image_hq`, `active`) VALUES
...
/*!40000 ALTER TABLE `{prefix}tag_blog` DISABLE KEYS */;
INSERT INTO `{prefix}tag_blog` (`id`, `name`, `frequency`) VALUES
  (1, 'yii', 1),
  (2, 'blog', 1),
  (4, 'asdf', 1),
  (5, 'testing', 1);
/*!40000 ALTER TABLE `{prefix}tag_blog` ENABLE KEYS */;

-- Volcando datos para la tabla publicidad.user: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `{prefix}user` DISABLE KEYS */;
INSERT INTO `{prefix}user` (`id`, `username`, `password`, `email`, `profile`) VALUES
