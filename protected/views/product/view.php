...
<div class="row-fluid">
	<div class="span5" style="margin:0 !important;padding:0 !important">
		<!-- <center> -->
			<?php 
			...
			?>		 
				...
				<div class="modal-body">
					<?php
						...
						echo CHtml::link('<img id="main-img" border="0" width="90%" title="'.$model->name.'" alt="-" src="'.$ruta.$model->image.'"/>', '#');
					?>
				</div>
			...
			<?php		
				$this->endWidget();
				$ruta=Yii::app()->baseUrl."/images/product/";
				echo CHtml::link('<img onclick="'.$openModal.'" id="main-img" border="0" width="85%" title="'.$model->name.'" alt="-" src="'.$ruta.$model->image.'"/>', '#');
			?>
		<!-- </center> -->
	<br/>	<br/>			
<div class="row-fluid">
	...
	<div class="fluid-row">
		<div class="span12 description">
			...
			<div class="fluid-row">
				...
				<p><a href="<?php echo $model->web; ?>" target="_blank"><?php echo $model->web; ?></a></p>
			</div>
			<div class="fluid-row price">
				<strong>
					<span><?php echo Yii::t('app','Descripción')?></span>
				</strong>
				<p><?php 
	...
	<div class="span7" style="margin:0 !important;padding:0 !important">
		<?php  
			echo $model->map;
		?>
	</div>
